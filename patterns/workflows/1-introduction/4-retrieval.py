...
if __name__ == "__main__":
    ...
    print(f"Source ID: {final_response.source}")
    print("-" * 50)

    # Test a question that doesn't trigger the tool
    print("\nTesting unrelated question...")
    print("-" * 50)
    
    # Create new messages for unrelated question
    messages = [
        {"role": "system", "content": system_prompt},
    ...
    # Print the response
    print(f"Message: {completion_3.choices[0].message.content}")
    print("-" * 50)
    # Test a question that doesn't trigger the tool
    print("\nTesting unrelated question...")
    print("-" * 50)
