...
class FileExplorerTool(BaseTool):
    ...
    description: str = "Useful for exploring and managing files in a directory. Supports actions: create_test, list, read, create_file, write_file, delete_file."
    ...
    def _run(self, query: str) -> str:
        ...
        try:
            ...
            return f"Unknown action: {action}. Available actions: create_test, list, read, create_file, write_file, delete_file"
